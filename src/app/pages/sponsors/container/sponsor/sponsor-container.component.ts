  ...
  NBLcontents: DSODSliderContent[] = [
    {
      ...
      src: 'assets/images/sponsor-images/align-banner-1.jpg',
      url: '',
  ...
  GSKcontents: DSODSliderContent[] = [
    {
      ...
      actionLink: '/',
      contentType: DSODContentType.Image,
      src: 'assets/images/sponsor-images/gsk-banner-1.jpg',
      url: '',
  ...
  ALNcontents: DSODSliderContent[] = [
    {
      ...
      actionLink: '/',
      contentType: DSODContentType.Image,
      src: 'assets/images/sponsor-images/noble-banner-1.jpg',
      url: '',
