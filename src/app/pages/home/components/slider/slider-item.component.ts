    ...
    <li class="glide__slide">
      <ng-template #image>
        ...
        <div class="slide-caption">
          ...
          <div class="join-wrap" *ngIf="!loggedIn && content.actionName">
            <a [routerLink]="[content.actionLink]" class="join-btn">{{
              content.actionName
            }}</a>
          </div>
        </div>
      </ng-template>
      <ng-template #video> <video src=""></video> </ng-template>
      <ng-container
        *ngTemplateOutlet="image; context: contentType === 'Image'"
      ></ng-container>
    </li>
  `,
