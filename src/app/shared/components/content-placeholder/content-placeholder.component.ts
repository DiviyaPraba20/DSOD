...
@Component({
  ...
  template: `
    <div class="content-block content-block-sm">
          ...
          <p *ngIf="showDescription" class="mt-3">
            This module will present best practices that allow you to use Invisalign outcome simulator in your practice…<a [routerLink]="['/article']">[more]</a>
          </p>
